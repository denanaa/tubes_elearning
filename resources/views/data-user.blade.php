            ...
            <form action="{{ route('update-user', $user->id) }}" method="POST" id="editForm">
                ...
                <div class="my-4 space-y-1">
                    ...
                    <input type="text" id="editName" name="name"
                        class="w-full h-10 px-3 py-2 text-sm bg-white border rounded-md" placeholder="Nama User">
                </div>
                <div class="my-4 space-y-1">
                    <label for="editEmail" class="text-sm font-medium">Email</label>
                    <input type="email" id="editEmail" name="email"
                        class="w-full h-10 px-3 py-2 text-sm bg-white border rounded-md" placeholder="Email User">
                </div>
                <div class="my-4 space-y-1">
                ...
                <div class="flex justify-end">
                    <button type="button" onclick="hideEditModal()"
                        class="bg-white text-gray-900 px-3 py-2 rounded-md">Cancel</button>
