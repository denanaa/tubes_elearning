                ...
                <tbody>
                    @foreach ($videos as $index => $video)
                        <tr class="odd:bg-white even:bg-gray-50 border-b text-center">
                            ...
                            <td class="px-6 py-4">
                                <button type="button"
                                    onclick="showEditModal('{{ $video->id_video }}', '{{ $video->title_video }}', '{{ $video->link_video }}', '{{ asset('storage/' . $video->thumbnail_video) }}', '{{ $video->description_video }}')"
                ...
                <div class="bg-white p-6  w-[90%] max-w-lg border rounded-lg shadow-sm bg-card text-neutral-900">
                    ...
                    <form action="{{ route('update-video', $video->id_video) }}" method="POST"
                        ...
                        <div class="my-4 space-y-1">
                            ...
                            <select id="editModul" name="id_module"
                    ...
                    @endforeach --}}
                        ...
                        <div class="my-4 space-y-1">
                            ...
                            <textarea type="text" id="editDescription" name="description_video" rows ="6"
                                value="{{ old('description_video', $video->description_video) }}"
                                ...
                                placeholder="Description Video"></textarea>
                        </div>
