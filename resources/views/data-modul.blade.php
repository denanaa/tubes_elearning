...
<div class="flex items-center mb-4">
    ...
    <a href="{{ route('create-kategori') }}" class="ml-auto text-white bg-blue-500 hover:bg-blue-600 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 focus:outline-none mb-2">Add Modul</a>
</div>
...
function hideEditModal() {
    ...
    if (query.length > 0) {
        fetch("{{ route('live-search-modul') }}?query=" + query)
            ...
            .catch(error => {
                document.querySelector('#modul-table tbody').innerHTML = '<tr><td colspan="4" class="text-center p-4 text-red-500">Error occurred</td></tr>';
            });
    } else {
