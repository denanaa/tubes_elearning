        ...
        <div class="container mx-auto p-2 bg-white rounded-xl mt-8"> 
          <div class="w-full max-w-6xl px-4 flex items-center space-x-4">
            ...
            <label class="form-control max-w-xs mb-6">
              ...
              <select class="select select-bordered select-primary max-w-xs overflow-y-auto max-h-24">
                <option disabled selected>Choose Type</option>
                <option>Everyday Conversations</option>
                <option>Role-Playing Scenarios</option>
                <option>Listening To Different Accents</option>
              </select>
            </label>
